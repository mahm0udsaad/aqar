...
// Static area mapping will be removed in favor of dynamic areas
...
export function SearchFilters({ filters, onFiltersChange, onClearFilters, categories, areas, isMobile = false, lng, dict }: SearchFiltersProps) {
